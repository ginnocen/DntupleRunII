...
TString prefilter = Form("(DlxyBS/DlxyBSErr)>1.5&&Dtrk1Pt>8.5&&Dtrk2Pt>8.5&&Dchi2cl>0.10&&(DsvpvDistance/DsvpvDisErr)>3.5&&Dalpha<0.12&&%s&&%s",mvatk.Data(),mbtrg.Data());
TString prefilterMC = Form("Dgen==23333&&(DlxyBS/DlxyBSErr)>1.5&&Dtrk1Pt>8.5&&Dtrk2Pt>8.5&&Dchi2cl>0.10&&(DsvpvDistance/DsvpvDisErr)>3.5&&Dalpha<0.12&&%s",mvatk.Data());
TString prefilterSW = Form("Dgen==23344&&(DlxyBS/DlxyBSErr)>1.5&&Dtrk1Pt>8.5&&Dtrk2Pt>8.5&&Dchi2cl>0.10&&(DsvpvDistance/DsvpvDisErr)>3.5&&Dalpha<0.12&&%s",mvatk.Data());
Bool_t isPbPb = false;
...
infnameMC ="/data/jisun/PbPb2015/Dntuple_crab_PbPb_HIMinimumBias3_ForestAOD_D0_tkpt0p7eta1p5_goldenjson_01292016.root";
infname = "/data/wangj/Data2015/Dntuple/PbPb/ntD_EvtBase_20160405_HIHardProbes_DfinderData_PbPb_20160402_dPt0tkPt2p5_D0Dstar3p5p_FINALJSON_jettriggerskim.root";
  ...
  if(!isPbPb)
    {
      TH1D* hpp_pt = getYield(root,rootMC,"","","","Dpt","pt","p_{T} (GeV/c)",1,50,100);
      TH1D* hpp_pt_Hlt = getYield(root,rootMC,Form("&&%s",trigger.Data()),Form("_%s",trigger.Data()),Form("*%s_Prescl",trigger.Data()),"Dpt","pt","p_{T} (GeV/c)",1,50,100);
      plotTurnOn(hpp_pt_Hlt,hpp_pt,trigger,Form("_%s",trigger.Data()),"pt","p_{T} (GeV/c)",1,50,100);
    }
}
