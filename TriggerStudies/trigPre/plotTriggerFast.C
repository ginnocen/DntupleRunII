...
void plotTriggerFast(string infname="/data/jisun/PbPb2015/skim_Dntuple_crab_PbPb_HIMinimumBias2_ForestAOD_Track_AK4CaloJet_D0_tkpt0p9eta1p5_01142016_tkpt8p0fortrigstudy.root")
{
   bool sideband = false;
   bool cent = false;
   ...
   //infname="/data/dmeson2015/DataDntuple/smalltest.root";
   //TString outf = "result";
   ...
   infname="/data/dmeson2015/DataDntuple/checktriggered.root";
