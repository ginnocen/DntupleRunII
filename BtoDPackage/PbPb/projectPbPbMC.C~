void projectPbPbMC()
{
  ...
  tMCP->Draw("Dmass:Dpt>>hPtMMCPSignal",weightfunctionreco*(cutpt&&cutPbPb&&cutmcSignal));
  tMCP->Draw("Dmass:Dpt>>hPtMMCPSwapped",weightfunctionreco*(cutpt&&cutPbPb&&cutmcSwapped));
