...
int triggerassignmentPP[nBins]= {3,3,3,3,3,3,3,3,3};

TString triggerHLTPbPb[ntriggers]={"HLT_HIDmesonHITrackingGlobal_Dpt20_v1","HLT_HIDmesonHITrackingGlobal_Dpt40_v1","HLT_HIDmesonHITrackingGlobal_Dpt60_v1","HLT_HIDmesonHITrackingGlobal_Dpt60_v1"};
int triggerHLTPbPbthresholds[ntriggers]={20,40,60,60};
