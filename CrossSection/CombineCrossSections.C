...
void CombineCrossSections()
{
  ...
  gaeBplusReferenceMB->SetFillColor(2);
  gaeBplusReferenceMB->SetFillStyle(3001); 
  gaeBplusReferenceMB->SetLineWidth(3);
  gaeBplusReferenceMB->SetLineColor(2);
  ...
  TH2F* hemptyRatio=new TH2F("hemptyRatio","",50,0.,110.,10.,0.,4);
