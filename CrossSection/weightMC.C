...
void weightPPFONLL(int minfit=2,int maxfit=100,TString pthat="pthatall")
{
  ...
  myweightfunctiongen=Form("%.2f+%f*Gpt+%f*Gpt*Gpt+%f*Gpt*Gpt*Gpt+%f*Gpt*Gpt*Gpt*Gpt+%f*Gpt*Gpt*Gpt*Gpt*Gpt",par0,par1,par2,par3,par4,par5);
  myweightfunctiongen=Form("%f+%f*Dgenpt+%f*Dgenpt*Dgenpt+%f*Dgenpt*Dgenpt*Dgenpt+%f*Dgenpt*Dgenpt*Dgenpt*Dgenpt+%f*Dgenpt*Dgenpt*Dgenpt*Dgenpt*Dgenpt",par0,par1,par2,par3,par4,par5);
  label="PP"+pthat;
